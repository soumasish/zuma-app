    ...
    try:
        ...
        for i, message in enumerate(result["messages"]):
            ...
            if hasattr(message, "tool_calls") and message.tool_calls:
                ...
                logger.info(
                    f"Message {i} additional_kwargs: {message.additional_kwargs}"
                )
                        ...
                        try:
                            ...
                            if tool_call.get("name") == "propose_tour":
                                ...
                                if "tour_slots" in tool_result:
                                    ...
                                    proposed_time = "11:00 AM, 2:00 PM"
        ...
        with next(session_gen) as session:
            human_message = message_repo.create_human_message(
                session, request_data.get("message", "")
            )
        ...
        response = {"reply": cleaned_message, "action": action}
